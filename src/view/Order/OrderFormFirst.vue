	...
	<form name="fdpay" id="fdpay" method="post">
		<table>
			...
			<tr>
				...
				<th class="white" align="right"><a href="javascript:makePayData();"><img src="img/btn_process.png" border=0 /></a>&nbsp;&nbsp;<a href="javascript:payProc();"><img src="img/btn_payment.png" border=0 /></a></th>
			</tr>
			<tr>
				<th>Description</th>
				<th>Values</th>
			...
			<tr>
				<td>* 결과수신URL</td>
				<td><input type="text" name="rtnUrl" id="rtnUrl" value="http://localhost:8080/utf8/layer.php" /></td>
				<td>수신 전체 웹 경로 입력(팝업창 호출 시:frame.php, 레이어 호출 시:layer.php) </td>
			</tr>
			<tr>
				<td> 상품종류</td>
				<td>
			...
			<tr>
				<td> 입금통보상세경로</td>
				<td><input type="text" name="DBPATH" id="DBPATH" value="/utf8/insert.php" /></td>
			...
			<tr>
				<td> 사용언어구분</td>
				<td><input type="text" name="LangType" id="LangType" value="ENG" /></td>
				<td>HAN:한글, ENG:영어</td>
			</tr>
			<tr>
				<td> 인코딩구분</td>
